...
?>
    ...
    <?php
require 'Usuario/menu.php';
?>
<main>
        <div class="slider-area ">
            <div class="slider-active">
                <div class="single-slider slider-height" data-background="../Vista/Usuario/assets/img/hero/h1_hero.jpg">
                    <div class="container">
                        <div class="row d-flex align-items-center justify-content-between">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 d-none d-md-block">
                                <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                                    <img src="../Vista/Usuario/assets/img/hero/hero_man.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row">
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img src="../Vista/Usuario/assets/img/categori/product1.png" alt="">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img src="../Vista/Usuario/assets/img/categori/product3.png" alt="">
                                        <div class="new-product">
                                            <span>New</span>
                                        </div>
                                    </div>
                        ...
                        <div class="section-tittle text-center mb-85">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img src="../Vista/Usuario/assets/img/categori/product4.png" alt="">
                                    </div>
                                    <div class="product-caption">
                                        <div class="product-ratting">
                                            <i class="far fa-star"></i>
                ...
                <div class="row d-flex justify-content-between align-items-end">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <div class="best-left-img mb-30 d-none d-sm-block">
                            <img src="../Vista/Usuario/assets/img/collection/collection1.png" alt="">
                        </div>
                    </div>
                     <div class="col-xl-2 col-lg-2 d-none d-lg-block">
                        <div class="best-mid-img mb-30 ">
                            <img src="../Vista/Usuario/assets/img/collection/collection2.png" alt="">
                        </div>
                    </div>
                        ...
                        <div class="best-right-cap ">
                           <div class="best-single mb-30">
                               ...
                               <div class="single-img">
                                  <img src="../Vista/Usuario/assets/img/collection/collection3.png" alt="">
                               </div>
                           </div>
                        </div>
                        <div class="best-right-cap">
                           <div class="best-single mb-30">
                               ...
                               <div class="single-img">
                                  <img src="../Vista/Usuario/assets/img/collection/collection4.png" alt="">
                               </div>
                           </div>
                        </div>
                        <div class="best-right-cap">
                           <div class="best-single mb-30">
                               ...
                               <div class="single-img">
                                  <img src="../Vista/Usuario/assets/img/collection/collection5.png" alt="">
                               </div>
                           </div>
                        </div>
                    </div> 
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="gallery-items">
                            <img src="../Vista/Usuario/assets/img/gallery/gallery1.jpg" alt="">
                        </div> 
                        <div class="gallery-items">
                            <img src="../Vista/Usuario/assets/img/gallery/gallery2.jpg" alt="">
                        </div>
                        <div class="gallery-items">
                            <img src="../Vista/Usuario/assets/img/gallery/gallery3.jpg" alt="">
                        </div>
                        <div class="gallery-items">
                            <img src="../Vista/Usuario/assets/img/gallery/gallery4.jpg" alt="">
                        </div>
                        <div class="gallery-items">
                            <img src="../Vista/Usuario/assets/img/gallery/gallery5.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
